...
{
	public class ExClickTheSphere_Idle_move_AddVector_1 
	{
		...
		public ExClickTheSphere_Idle_move_AddVector_1 (ExClickTheSphere_Idle_move setExClickTheSphere_Idle_move) 
		{
		...
		{
			vector3Values [0] = exClickTheSphere_Idle_move.exClickTheSphere_Idle_move_AddVector.vector3Value;

			vector3Values [1] = exClickTheSphere_Idle_move.exClickTheSphere_Idle_move_Set_Z.vector3Value;
