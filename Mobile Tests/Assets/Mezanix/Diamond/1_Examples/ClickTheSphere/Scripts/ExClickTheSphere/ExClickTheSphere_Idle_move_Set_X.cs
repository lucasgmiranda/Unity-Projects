...
{
	public class ExClickTheSphere_Idle_move_Set_X 
	{
		...
		public ExClickTheSphere_Idle_move_Set_X (ExClickTheSphere_Idle_move setExClickTheSphere_Idle_move) 
		{
		...
		{
			floatValues [0] = exClickTheSphere_Idle_move.exClickTheSphere_Idle_move_GetX.floatValue;
