...
{
	public class ExClickTheSphere_Idle_move_Set_Y 
	{
		...
		public ExClickTheSphere_Idle_move_Set_Y (ExClickTheSphere_Idle_move setExClickTheSphere_Idle_move) 
		{
		...
		{
			floatValues [0] = exClickTheSphere_Idle_move.exClickTheSphere_Idle_move_GetY.floatValue;
