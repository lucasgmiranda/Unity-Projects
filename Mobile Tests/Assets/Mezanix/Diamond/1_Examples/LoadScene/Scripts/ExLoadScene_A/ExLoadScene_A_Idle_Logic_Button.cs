...
{
	public class ExLoadScene_A_Idle_Logic_Button 
	{
		...
		public ExLoadScene_A_Idle_Logic_Button (ExLoadScene_A_Idle_Logic setExLoadScene_A_Idle_Logic) 
		{
			...
			{
				gameObjectValues [0] = (GameObject)identifiedObjects.GetIdentifiedObject ("7_17_2017_4_07_32_PM_5766.gameObjectValues_0");
			}
		...
		{
			gameObjectValues [0] = exLoadScene_A_Idle_Logic.exLoadScene_A_Idle.exLoadScene_A.attachedToGameObject;
