...
{
	public class ExMoveSphere_Idle_Logic_PutY 
	{
		...
		public ExMoveSphere_Idle_Logic_PutY (ExMoveSphere_Idle_Logic setExMoveSphere_Idle_Logic) 
		{
		...
		{
			floatValues [0] = exMoveSphere_Idle_Logic.exMoveSphere_Idle_Logic_Vertical.floatValue;
