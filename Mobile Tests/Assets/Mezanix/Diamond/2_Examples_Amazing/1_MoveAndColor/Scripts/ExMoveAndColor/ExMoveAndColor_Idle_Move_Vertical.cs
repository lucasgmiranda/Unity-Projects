...
{
	public class ExMoveAndColor_Idle_Move_Vertical 
	{
		...
		public ExMoveAndColor_Idle_Move_Vertical (ExMoveAndColor_Idle_Move setExMoveAndColor_Idle_Move) 
		{
			exMoveAndColor_Idle_Move = setExMoveAndColor_Idle_Move;

			exMoveAndColor_Idle_Move.IAmHere ();

			stringValues [0] = "Vertical";
			stringValues [1] = "";
		}
