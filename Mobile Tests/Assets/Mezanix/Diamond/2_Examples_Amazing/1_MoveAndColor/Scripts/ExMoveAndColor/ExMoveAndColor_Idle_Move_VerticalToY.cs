...
{
	public class ExMoveAndColor_Idle_Move_VerticalToY 
	{
		...
		public ExMoveAndColor_Idle_Move_VerticalToY (ExMoveAndColor_Idle_Move setExMoveAndColor_Idle_Move) 
		{
		...
		{
			floatValues [0] = exMoveAndColor_Idle_Move.exMoveAndColor_Idle_Move_Vertical.floatValue;
