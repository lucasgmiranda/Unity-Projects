...
{
	public class ExAnimationCurves_Idle_Logic_AnimateTransformRotation 
	{
		...
		public ExAnimationCurves_Idle_Logic_AnimateTransformRotation (ExAnimationCurves_Idle_Logic setExAnimationCurves_Idle_Logic) 
		{
			...
			{
				gameObjectValues [0] = (GameObject)identifiedObjects.GetIdentifiedObject ("8_15_2017_10_58_35_AM_5146.gameObjectValues_0");
			}
			...
			vector3Values [1] = new Vector3 (30f, 120f, 270f);
