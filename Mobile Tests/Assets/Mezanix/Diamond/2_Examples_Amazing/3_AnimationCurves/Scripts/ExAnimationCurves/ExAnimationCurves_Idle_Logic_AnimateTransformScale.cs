...
{
	public class ExAnimationCurves_Idle_Logic_AnimateTransformScale 
	{
		...
		public ExAnimationCurves_Idle_Logic_AnimateTransformScale (ExAnimationCurves_Idle_Logic setExAnimationCurves_Idle_Logic) 
		{
			...
			{
				gameObjectValues [0] = (GameObject)identifiedObjects.GetIdentifiedObject ("8_15_2017_10_59_38_AM_5250.gameObjectValues_0");
			}
			...
			vector3Values [0] = new Vector3 (1f, 1f, 1f);
			vector3Values [1] = new Vector3 (1.5f, 2f, 3f);
		...
		void ComputeTransform ()
		{
			...
			exAnimationCurves_Idle_Logic.exAnimationCurves_Idle.exAnimationCurves.StartCoroutine (RunAnimationCurve_transformRotation ());
