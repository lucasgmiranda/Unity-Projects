...
{
	public class ExDataTransferSender : MonoBehaviour 
	{
		[HideInInspector] 
		public IExDataTransferSender currentState; 

		[HideInInspector] 
		public ExDataTransferSender_Idle idle; 
		...
		{ 
			...
			idle = new ExDataTransferSender_Idle (this);
		} 
