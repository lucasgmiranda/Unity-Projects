...
{
	public class ExAtStateStart_Counter : IExAtStateStart 
	{
		public ExAtStateStart_Counter_Logic exAtStateStart_Counter_Logic;
		
		public ExAtStateStart exAtStateStart; 

		public ExAtStateStart_Counter (ExAtStateStart setExAtStateStart) 
		{
			exAtStateStart = setExAtStateStart;

			exAtStateStart_Counter_Logic = new ExAtStateStart_Counter_Logic (this);
		}

		public void StateUpdate () 
		{
			exAtStateStart_Counter_Logic.LogicUpdate ();
		}
